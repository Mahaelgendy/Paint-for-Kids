...
public:
	...
	void setCrntDrawColor(color _color) const;	//set current drwawing color
	void setCrntFillColor(color _fillColor) const;	//set current filling color
	void setBackgroundColor(color _backgroundColor) const;
